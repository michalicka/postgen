...
Vue.component('BaseCard', require('./Ui/BaseCard.vue').default);
Vue.component('BaseInput', require('./Form/BaseInput.vue').default);
Vue.component('BaseCheckbox', require('./Form/BaseCheckbox.vue').default);
Vue.component('BaseLabel', require('./Form/BaseLabel.vue').default);
Vue.component('BaseButton', require('./Form/BaseButton.vue').default);
// Vue.component('BaseLink', require('./Form/BaseLink.vue').default);
Vue.component('FormError', require('./Form/FormError.vue').default);
